...
println!();
println!("{} is aimed at deve;oping competent, creative, innovative, enterpreneurial and
 ethically-minded persons, capable of creating value in the diverse fields of Computer Science.", w3);
